...
class Cheobang(QWidget):
    ...
    def setupUI(self):
        ...
        global ID
        if(ID!=-10):
            Sul = QtUiTools.QUiLoader().load(resource_path("cheobang.ui"))


            global KSD
            KSD = str(ID)+ '(cheobang).csv'
            print(KSD)
            
        
            Sul.setWindowTitle(KSD)
            Sul.setGeometry(500, 300, 800, 400)
            ...
            Sul.resulttable.setColumnWidth(0, 150)
            Sul.resulttable.setColumnWidth(1, 50)
            Sul.resulttable.setColumnWidth(2, 100)
            Sul.resulttable.setColumnWidth(3, 350)
            Sul.resulttable.setColumnWidth(4, 50)
            Sul.resulttable.setColumnWidth(5, 50)
