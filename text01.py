...
class Susul(QWidget):
    ...
    def setupUI(self):
        ...
        global ID
        if(ID!=-10):
            Sul = QtUiTools.QUiLoader().load(resource_path("susul2.ui"))
            ...
            Sul.setGeometry(300, 100, 700, 400)
