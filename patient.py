...
class patient(QWidget):
    ...
    def setupUI(self):
        ...
        if(ID!=-10):
            ...
            global KSD
            KSD = "D:/workspace_python/univ_basic_sw/EMR_System/EMR_DATA/patientData.csv"
    ...
    def save2(self):
        with open(KSD, 'r', encoding='UTF8') as file:
            data = file.readlines() 
        roA = 0
        Fr = open(KSD,'r',newline="", encoding='UTF8')
        ...
        with open(KSD, 'w', encoding='UTF8') as file:
