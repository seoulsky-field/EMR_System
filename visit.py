...
class Naewon(QWidget):
    ...
    def setupUI(self):
        ...
        if(ID!=-10):
            ...
            global KSD
            KSD = "D:/workspace_python/univ_basic_sw/EMR_System/EMR_DATA/" + ID+ '_visit.csv'
            print(KSD)
    ...
    def setTablewidgetdata(self):
        ...
        for line in ReadF:
            ...
            Sul.resulttable.setItem(row-1, 6, QTableWidgetItem(item6))
    ...
    def save2(self):
        Fr = open(KSD,'w',newline="", encoding='euc-kr')
        WriteF = csv.writer(Fr)
        
        row_count = Sul.resulttable.rowCount()
        
        WriteF.writerow(['진료날짜','내원 구분','진료 과','진료의','환자 통증','담당의 소견' , '의료 영상'])
